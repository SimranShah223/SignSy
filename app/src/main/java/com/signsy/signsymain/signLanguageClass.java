...
public class signLanguageClass {
    ...
    signLanguageClass(Button clear_sentence, Button add_word_button, Button clear_button, Button add_button, TextView change_text, TextView final_sentence, AssetManager assetManager, String modelPath, String labelPath, int inputSize, String classification_model, int classification_input_size) throws IOException{
        ...
        add_word_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final_text = "";
                change_text.setText(final_text);
                final_sentence.setText(sentence);
            }
        });

        clear_sentence.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sentence="";
                final_sentence.setText(sentence);
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                // Use pyttext to add Class Name in image
